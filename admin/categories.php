				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control text-right" name="capacity">
							</div>
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										...
										<p>Price : <b><?php echo "Ks ".number_format($row['price'],2) ?></b></p>
										<p>Capacity : <b><?php echo $row['Room_count'] ?></b></p>
									</td>
									
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_cat" type="button" data-id="<?php echo $row['id'] ?>" data-name="<?php echo $row['name'] ?>" data-price="<?php echo $row['price'] ?>" data-capacity="<?php echo $row['Room_count'] ?>"data-cover_img="<?php echo $row['cover_img'] ?>">Edit</button>
