                    				...
                    				<form action="index.php?page=list" id="filter" method="POST">
                    					<div class="row">
                    						<div class="col-md-3">
                    							...
                    							<input type="date" class="" name="date_in" autocomplete="off">
                    						</div>
                    						<div class="col-md-3">
                    							<label for="">Check-out Date</label>
                    							<input type="date" class="" name="date_out" autocomplete="off">
                    						</div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="#">
                            ...
                            <div class="portfolio-box-caption">
                                <div class="project-category text-white-30"><?php echo "Ks ".number_format($row['price'],2) ?> per day</div>
