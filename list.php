									...
									<form action="index.php?page=list" id="filter" method="POST">
			        					<div class="row">
			        						<div class="col-md-3">
			        							...
			        							<input type="date" class="" name="date_in" autocomplete="off" value="<?php echo isset($date_in) ? date("Y-m-d",strtotime($date_in)) : "" ?>">
			        						</div>
			        						<div class="col-md-3">
			        							<label for="">Check-out Date</label>
			        							<input type="date" class="" name="date_out" autocomplete="off" value="<?php echo isset($date_out) ? date("Y-m-d",strtotime($date_out)) : "" ?>">
			        						</div>
			        						<div class="col-md-3">
			        							<br>
			        							<button class="btn">Available Room</button>
			        						</div>
						...
						<div class="card item-rooms mb-3">
							<div class="card-body">
								...
								<div class="col-md-5" height="100%">
									<h3><b><?php echo 'Ks '.number_format($cat_arr[$row['category_id']]['price'],2) ?></b><span> / per day</span></h3>
...
<section class="page-section bg-dark"></section>
<style type="text/css">
	.item-rooms img {
    width: 23vw;
}
